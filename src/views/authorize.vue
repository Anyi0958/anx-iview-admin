      ...
      <Col class="layout" :style="{ width: userInfo ? '450px' : '390px' }">
        <div>
          <div class="logos-wrap">
            <div class="logos">
              <Avatar
                ...
                class="top site-logo"
              />
              <Icon type="ios-checkmark-circle" color="#52c41a" size="32" class="top"></Icon>
              <Avatar
          ...
          <Row v-if="!error && !authLoading && !userInfo">
            ...
            <Row>
              <Button type="primary" size="large" :loading="loading" long @click="submit">
            ...
            <Row type="flex" justify="space-between" class="other-thing">
              <router-link to="/reset" class="back">{{ $t("forgetPass") }}</router-link>
          ...
          <div v-if="!error && !authLoading && userInfo">
            <Card v-if="!error" dis-hover :padding="0">
              <div class="auth-card">
                <div class="auth-info-wrap">
                  <div class="auth-detail" style="margin-bottom: 25px">
                    ...
                    />
                    <div>
                      <a :href="site.homeUri" target="_blank" class="auth-detail-href">
                        {{ site.name }}
                      </a>
                      <div class="auth-detail-sub-title">
                        {{ $t("wants") }}
                        <span class="auth-detail-strong">{{ userInfo.username }}</span>
                        {{ $t("wants2") }}
                      </div>
                    </div>
                  </div>
                  <div class="auth-detail" style="margin-bottom: 15px">
                    <Icon type="md-person" color="#6a737d" size="40" class="auth-pic"></Icon>
                    <div>
                ...
                <Row class="button-confirm">
                  <Button type="primary" size="large" :loading="loading" long @click="confirm">
