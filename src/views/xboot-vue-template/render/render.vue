...
<template>
  <div class="render">
    ...
    <Drawer v-model="infoDrawerVisible" width="640" title="详细信息">
    ...
    <Drawer v-model="editDrawerVisible" title="编辑" :mask-closable="false" width="720">
      <div :style="{ maxHeight: maxHeight }" class="drawer-content">
        <Form :model="infoForm" label-position="top">
          ...
          <FormItem label="描述">
            <Input v-model="infoForm.desc" type="textarea" :rows="4" />
          </FormItem>
        </Form>
      </div>
