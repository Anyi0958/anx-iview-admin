<template>
  <div class="search">
    ...
    <invite v-model="showInvite" :transfer-data="transferData" />
  </div>
</template>
      ...
      columns: [
        ...
        },
        {
          ...
          render: (h, params) => {
            let button;
            if (params.row.status == 0) {
              button = h("DropdownItem", { props: { name: "disable" } }, "禁用");
            } else {
              ...
              h(
                ...
                [
                  ...
                  h("DropdownMenu", { slot: "list" }, [
                    h("DropdownItem", { props: { name: "invite" } }, "邀请记录"),
                    h("DropdownItem", { props: { name: "vip" } }, "VIP开通记录"),
                    h("DropdownItem", { props: { name: "recharge" } }, "充值记录"),
                    button,
