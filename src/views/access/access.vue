  ...
  <div class="access">
    <Row>
      <Col :lg="24" :xl="8" style="padding: 0 10px 10px 0">
        <Card>
          <p slot="title">
            <Icon type="md-contact" style="margin-right: 5px"></Icon>
            当前用户
          </p>
            ...
            <Col span="17" class="padding-left-10">
              <Row type="flex" justify="center" align="middle" class="access-change-access-con-row">
                <p>
                  ...
                  <br />
                  <br />
                  说明：该Demo大部分页面为演示功能，前端未配置根据权限隐藏按钮
                </p>
              </Row>
            </Col>
          </div>
    ...
    <Row>
      <Col :lg="24" :xl="14" style="padding: 0 10px 10px 0">
        <Card>
          <p slot="title">
            <Icon type="md-grid" style="margin-right: 5px"></Icon>
            表格中权限判断
          </p>
      ...
      <Col :lg="24" :xl="10" style="padding: 0 10px 10px 0">
        <Card>
          ...
          <Row class="content-role">
            ...
            <div class="btns">
              <Button v-hasRole="'ROLE_USER'" type="primary" style="margin-right: 5px">
                添加按钮
              </Button>
