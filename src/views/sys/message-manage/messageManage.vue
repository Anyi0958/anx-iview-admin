...
<template>
  <div class="search">
    <addEdit
      ...
      @submited="submited"
    />
    <detail v-model="showDetail" :transfer-data="transferData" />
    <Card v-show="currView == 'index'">
        ...
        <Form ref="searchForm" :model="searchForm" inline :label-width="70">
          ...
          <span v-if="drop">
            <FormItem label="消息类型" prop="type">
              <dict v-model="searchForm.type" dict="message_type" style="width: 200px" />
            </FormItem>
            <FormItem label="创建时间">
              <DatePicker
                v-model="selectDate"
      ...
      <Row class="operation">
        <Button type="primary" icon="md-add" @click="add">发送新消息</Button>
        <Button icon="md-trash" @click="delAll">批量删除撤回</Button>
...
<script>
import { getMessageData, addMessage, editMessage, deleteMessage } from "@/api/index";
