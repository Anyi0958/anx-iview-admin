<template>
  <div class="user-edit">
    <!-- Drawer抽屉 -->
    <Drawer v-model="visible" :title="title" width="720" draggable :mask-closable="type == '0'">
      <div :style="{ maxHeight: maxHeight }" class="drawer-content">
        <div class="drawer-header">
          <div style="margin-right: 16px">基本信息</div>
          <Avatar v-show="type != '2'" :src="form.avatar" size="large" />
        </div>
        <Form v-show="type != '2'" label-colon>
          <Row :gutter="32">
            <Col span="12">
              <FormItem label="用户ID">
                {{ form.id }}
        ...
        <Form ref="form" :model="form" :rules="formValidate" label-position="top">
          ...
          <Row :gutter="32">
            ...
            <Col span="12">
              <FormItem label="性别">
                <dict v-model="form.sex" dict="sex" transfer />
              </FormItem>
            </Col>
          </Row>
          <Row :gutter="32">
          ...
          <Row :gutter="32">
            <Col span="12">
              <FormItem label="所在地区" prop="address">
                <al-cascader v-model="form.address" data-type="name" level="2" transfer />
              </FormItem>
            </Col>
            <Col span="12">
              <FormItem label="街道地址">
      ...
      <div v-show="type != '0'" class="drawer-footer br">
