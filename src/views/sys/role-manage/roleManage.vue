...
<template>
  <div class="search">
    ...
    <!-- 编辑 -->
    <Modal v-model="roleModalVisible" :title="modalTitle" :mask-closable="false" :width="500">
    ...
    >
      ...
      <div class="drawer-footer br">
        ...
        <Select v-model="openLevel" style="width: 110px" transfer @on-change="changeOpen">
    ...
    >
      ...
      <div v-show="dataType == 1" style="margin-top: 15px">
        <div style="position: relative">
          ...
          ></Tree>
          <Spin v-if="depTreeLoading" size="large" fix></Spin>
        </div>
      </div>
      <div slot="footer">
