...
<template>
  <div class="search">
    <Card>
      ...
      <Row class="operation">
        <Button icon="md-trash" @click="delAll">批量删除解绑</Button>
    ...
    return {
      ...
      columns: [
        ...
        },
        {
          ...
          fixed: "left",
          render: (h, params) => {
            if (this.$route.meta.permTypes && this.$route.meta.permTypes.includes("view")) {
          ...
          render: (h, params) => {
            if (params.row.avatar) {
              ...
              let name = "",
                color = "";
              // 过滤特殊字符
              let username = params.row.username.replace(/[^\u4e00-\u9fa5\w]/g, "");
