    ...
    <Row :gutter="gutterNum">
      <Col v-if="show(0)" :span="span">
        <Select
          ...
          @on-change="hasChange"
        >
          <Option v-for="item in provList" :key="item" :value="item">{{ item }}</Option>
        </Select>
      </Col>
      <Col v-if="show(1)" :span="span">
        <Select
          ref="city"
          v-model="currCit"
          :filterable="searchable"
      ...
      <Col v-if="show(2)" :span="span">
        <Select
          ...
          @on-change="hasChange"
        >
          <Option v-for="item in counList" :key="item" :value="item">{{ item }}</Option>
        </Select>
      </Col>
      <Col v-if="show(3)" :span="span">
        <Select
          ref="stre"
          v-model="currStr"
          :filterable="searchable"
          ...
          @on-change="hasChange"
        >
          <Option v-for="item in streList" :key="item" :value="item">{{ item }}</Option>
        </Select>
      </Col>
    </Row>
    <slot></slot>
