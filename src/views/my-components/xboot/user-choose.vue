<template>
  <div class="user-choose">
    <Button :icon="icon" @click="userModalVisible = true">{{ text }}</Button>
    ...
    <Drawer v-model="userModalVisible" title="选择用户" closable width="800" draggable>
      <Form ref="searchUserForm" :model="searchUserForm" inline :label-width="55">
        ...
        <FormItem style="margin-left: -35px" class="br">
          <Button type="primary" icon="ios-search" @click="handleSearchUser">搜索</Button>
