<template>
  <div>
    <div :id="`${id}-toolbar`">
      ...
      <button v-if="base64" class="ql-image" title="插入图片"></button>
      <div v-if="!base64" class="q-menu" title="插入图片">
        <Upload
      ...
      <div v-if="expandHtml" class="q-menu" title="编辑HTML代码" @click="editHTML">
        <Icon type="md-code-working" size="22" />
      </div>
      <div v-if="expandPreview" class="q-menu" title="预览" @click="fullscreenModal = true">
        <Icon type="ios-eye" size="24" />
      </div>
      <div v-if="expandClear" class="q-menu" title="清空" @click="clear">
    ...
    <Modal v-model="fullscreenModal" title="预览" fullscreen>
