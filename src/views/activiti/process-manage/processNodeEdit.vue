...
<template>
  <div class="search">
    <Card style="min-height: 600px">
      ...
      <Row v-show="current == 0" type="flex" justify="center">
                ...
                <Poptip trigger="click" placement="right" title="选择类别" width="250">
                  ...
                  <div slot="content">
                    ...
                    <div class="tree-list">
                      ...
                      ></Tree>
                      <Spin v-if="catLoading" size="large" fix></Spin>
                    </div>
                  </div>
                </Poptip>
              </div>
      ...
      <Row v-if="current == 1" type="flex" justify="start">
        <Col :md="8" :lg="8" :xl="6">
          <Alert show-icon>
            当前选择编辑：
          ...
          <Form ref="form" :model="form" :label-width="90" style="position: relative">
            ...
            <FormItem label="节点类型" prop="type">
              <Select v-model="form.type" disabled style="width: 300px">
                <Option v-for="(item, i) in dictNodeType" :key="i" :value="item.value">
                  {{ item.title }}
                </Option>
              </Select>
            </FormItem>
            <div v-show="form.type == 0">
              <FormItem label="可发起人员">
                ...
                <Checkbox v-model="chooseRole" :disabled="allUser" @on-change="clickRole">
                ...
                <Checkbox v-model="chooseUser" :disabled="allUser" @on-change="clickUser">
            ...
            <div v-show="form.type == 1">
              <FormItem label="可审批人员">
                <Checkbox v-model="chooseRole" :disabled="form.customUser" @on-change="clickRole">
                  <Icon type="md-people" size="14" style="margin: 0 2px 0 0"></Icon>
                  <span>指定角色</span>
                </Checkbox>
                <Checkbox
                ...
                <Checkbox v-model="chooseUser" :disabled="form.customUser" @on-change="clickUser">
                  <Icon type="md-person" style="margin: 0 2px 0 0"></Icon>
                  <span>指定人员</span>
                </Checkbox>
            ...
            <div
              v-show="
                chooseDepartment &&
                ((form.type == 0 && !allUser) || (form.type == 1 && !form.customUser))
              "
            >
              <FormItem label="选择部门">
            ...
            >
              <FormItem label="选择用户">
                <user-choose ref="user" @on-change="handleSelectUser"></user-choose>
              </FormItem>
            </div>
            <FormItem class="br">
              <Button
            ...
            <Spin v-if="nodeLoading" size="large" fix></Spin>
          </Form>
        </Col>
      </Row>
    </Card>
  ...
  data() {
    return {
      ...
      formValidate: {
        ...
        businessTable: [{ required: true, message: "不能为空", trigger: "change" }],
      },
      categoryTitle: "",
      dictTable: [],
      dictForm: [],
