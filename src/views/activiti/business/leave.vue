  ...
  <div class="search">
    <Card>
      ...
      <Row>
        ...
        >
          <FormItem v-if="type != 0 && type != 1" label="请假申请人" prop="title">
            {{ form.createBy }}
          </FormItem>
          <FormItem label="请假类型" prop="type">
            <dict v-model="form.type" dict="leave_type" style="width: 300px" />
          </FormItem>
          ...
          <FormItem class="br">
            ...
            <Button v-if="type != 0" type="info" @click="handelPrint">打印</Button>
