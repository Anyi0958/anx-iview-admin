      ...
      <Col class="layout">
        <div>
          ...
          <Row v-if="!relateLoading">
            ...
            <Row>
              <Button type="primary" size="large" :loading="loading" long @click="checkVaptcha">
...
import { vaptchaID, vaptchaOffline, relate, userInfo, getJWT, getOtherSet } from "@/api/index";
