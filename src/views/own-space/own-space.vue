          ...
          <div>
            <div v-show="currMenu == '基本信息'">
              <Form ref="form" :model="form" :label-width="90" label-position="left">
                <FormItem label="登录账号：" prop="username">{{ form.username }}</FormItem>
                <FormItem label="用户头像：">
                  <upload-pic-thumb v-model="form.avatar" :multiple="false"></upload-pic-thumb>
                </FormItem>
                <FormItem label="用户名：" prop="nickname">
                  <Input v-model="form.nickname" style="width: 300px" />
                </FormItem>
                <FormItem label="性别：">
                  <dict v-model="form.sex" dict="sex" style="width: 300px" />
                </FormItem>
                <FormItem label="生日：">
                  <DatePicker
                    v-model="form.birth"
            ...
            <div v-show="currMenu == '第三方账号绑定'" class="safe">
                  ...
                  <div>
                    ...
                    <div class="desc">
                      <span v-if="relate.github">
                        已绑定Github账号：{{ relate.githubUsername }}
                      </span>
              ...
              <div class="item">
                <div style="display: flex; align-items: center">
                  <img src="@/assets/dingding.png" width="41px" style="margin-right: 16px" />
                  <div>
                    <div class="title">钉钉</div>
                    <div class="desc">
                      <span v-if="relate.dingding">
                        已绑定钉钉账号：{{ relate.dingdingUsername }}
                      </span>
              ...
              <div class="item">
                <div style="display: flex; align-items: center">
                  <img src="@/assets/qiyeweixin.png" width="41px" style="margin-right: 16px" />
                  <div>
                    <div class="title">企业微信</div>
                    <div class="desc">
                      <span v-if="relate.workwechat">
                        已绑定企业微信账号：{{ relate.workwechatUsername }}
                      </span>
              ...
              <Spin v-if="jumping" fix>跳转中...</Spin>
            </div>
...
export default {
  ...
  data() {
    return {
      ...
      mobileEditValidate: {
        mobile: [{ required: true, message: "请输入手机号码" }, { validator: validateMobile }],
      },
      emailEditValidate: {
        email: [
